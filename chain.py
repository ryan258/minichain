...
class FusionChainResult(BaseModel):
    ...
    model_names: List[str] = Field(alias="model_names")


class FusionChainResult(BaseModel):
    model_names: list = Field(alias="model_names")

    class Config:
        # Resolves the conflict by ensuring that 'model_' is treated as a protected namespace
        # protected_namespaces = ('model_',)

        # Alternatively, you can completely disable protected namespaces if appropriate
        protected_namespaces = ()

        # Suppress the warning by treating 'model_names' as an explicitly declared field
